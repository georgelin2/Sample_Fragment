...
import com.george.samplefragment.databinding.FragmentFrag1Binding
...
class frag1 : Fragment() {
    ...
    private lateinit var _binding: FragmentFrag1Binding
    ...
    override fun onCreateView(
        ...
        binding.btnGotoFrag2.setOnClickListener { v ->
            findNavController().navigate(R.id.action_frag1_to_frag2)
        }
        binding.btnGotoFrag3.setOnClickListener { v ->
            findNavController().navigate(R.id.action_frag1_to_frag3)
        }
